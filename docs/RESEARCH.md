...
3. Mission Agent, Deterministic? 


## Goal:

create an autonomous agent that can travel and gather information, space or underwater, create an entity can has all the exploration traits in it.


## A Parasite:

it can attach to a certain living fish or creature, and survive from sticking into it.
